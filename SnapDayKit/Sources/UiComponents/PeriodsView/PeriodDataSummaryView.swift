  ...
  public var body: some View {
    VStack(alignment: .leading, spacing: 5.0) {
      HStack(alignment: .center,spacing: 2.5) {
        ...
        Spacer()
        Text(TimeProvider.duration(from: periodSummaryData.totalAvailableTime, bundle: .module) ?? "")
      ...
      HStack(alignment: .center,spacing: 2.5) {
        ...
        Text("Total Planned Time", bundle: .module)
          ...
          .foregroundStyle(Color.standardText)
        Spacer()
        Text(TimeProvider.duration(from: periodSummaryData.totalPlannedTime, bundle: .module) ?? "")
          .font(.system(size: 12.0, weight: .semibold))
          .foregroundStyle(Color.standardText)
      ...
      HStack(alignment: .center, spacing: 2.5) {
        ...
        Text("Total Completed Time", bundle: .module)
          ...
          .foregroundStyle(Color.standardText)
        Spacer()
        Text(TimeProvider.duration(from: periodSummaryData.totalCompletedTime, bundle: .module) ?? "")
          .font(.system(size: 12.0, weight: .semibold))
          .foregroundStyle(Color.standardText)
